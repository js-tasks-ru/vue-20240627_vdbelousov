  ...
  template: `
    <div class="meetup-selector">
      <div class="meetup-selector__control">
        <button class="button button--secondary" type="button" :disabled="meetupId < 2" @click="meetupId--">Предыдущий</button>
        ...
        <button class="button button--secondary" type="button" :disabled="meetupId > 4" @click="meetupId++">Следующий</button>
      </div>
